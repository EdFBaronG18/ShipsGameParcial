...
public class Ligth {
    public static final int SPRITE_SIZE_WIDTH =5;
    public static final int SPRITE_SIZE_HEIGTH=5;
    public static final float GRAVITY_FORCE=10;
    private final int MIN_SPEED = 1;
    private final int MAX_SPEED = 20;
    private final int image = R.drawable.snow;
    private float maxY;
    private float maxX;
    private float width;
    ...
    public Ligth(Context context, float screenWidth, float screenHeigth, float i){
        speed = 5;
    ...
    public void updateInfo() {
        ...
        if (positionX < 0) {
            positionX = this.maxX;
            positionY = random.nextInt((int) this.maxY);
